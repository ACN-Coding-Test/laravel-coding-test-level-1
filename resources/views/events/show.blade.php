		...
		<div class="col-md-6 mx-auto">
			<div class="card mt-3 ">
			  <div class="card-body">
    			...
    			<small class="text-muted"><em>Created At: {{Carbon\Carbon::parse($event->createdAt)->toDateTimeString()}}</em></small><br>
    			<small class="text-muted"><em>Updated At: {{Carbon\Carbon::parse($event->updatedAt)->toDateTimeString()}}</em></small><br>
