...
<div class="container">
    <span class="pull-left">Welcome <span class="text-primary">{{ ucwords(Session::get('user'))}}</span></span>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$event->startAt}}</td>
                    <td>{{$event->endAt}}</td>
                    <td><a href="/events/{{$event->id}}/edit" class="btn btn-primary btn-sm">Update</a></td>
                    <td>
