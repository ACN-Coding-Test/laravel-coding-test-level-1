...
<?php $component->withAttributes(['bodyClass' => 'g-sidenav-show bg-gray-200']); ?>
    ...
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.navbars.sidebar','data' => ['activePage' => 'user-profile']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n0">
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        <form method='POST' action="/events/<?php echo e($result[0]->id); ?>/edit">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Name</label>
                                    <input type="text" name="name" class="form-control border border-2 p-2" value='<?php echo e($result[0]->name); ?>'>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="slug" class="form-control border border-2 p-2" value='<?php echo e($result[0]->slug); ?>'>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="datetime-local"  name="startAt" class="form-control border border-2 p-2" value='<?php echo e($result[0]->startAt); ?>'>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="datetime-local"  name="endAt" class="form-control border border-2 p-2" value='<?php echo e($result[0]->endAt); ?>'>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH E:\GITHUB\accenturephp\laravel-coding-test-level-1\resources\views/pages/laravel-examples/user-profile.blade.php ENDPATH**/ ?>